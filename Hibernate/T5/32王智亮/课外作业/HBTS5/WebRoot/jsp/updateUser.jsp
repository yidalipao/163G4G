...
<html>
  ...
  <body>
    ...
    <s:password  name="user.password" showPassword="true" value="%{#user.password}"  label="密码" ></s:password><br>

 	<s:textfield name="birthday" value="%{user.birthday}" label="生日"></s:textfield><br>
